...
function PeltTracker.init()
    ...
    local function scanAll()
        ...
        for _, f in ipairs(root:GetChildren()) do
            if f:IsA("Folder") then
                local torso = f:FindFirstChild("Character")
                            and f.Character:FindFirstChild("Torso")
                if torso then
    ...
    local function addMapMarker(folder)
        ...
        part.Size, part.Anchored, part.CanCollide, part.Transparency =
            Vector3.new(1,1,1), true, false, 0.7
